...
router.get("/places", isAuth, adminController.getPlaces);

router.get("/places/:placeId", isAuth, adminController.getPlace);
...
router.delete("/places/:placeId", isAuth, isOwner, adminController.deletePlace);
...
router.get("/categories/:categoryId", isAuth, adminController.getCategory);
...
router.get("/places/:placeId/types", isAuth, adminController.getTypes);

router.get("/types/:typeId", isAuth, adminController.getType);
...
router.delete("/types/:typeId", isAuth, isOwner, adminController.deleteType);
